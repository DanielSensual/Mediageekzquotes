    ...
    return (
        <>
            ...
            <div className="page-shell">
                ...
                {/* ═══ INVESTMENT / PRICING ═══ (HIDDEN — pricing meeting pending) */}
                <section className="th-section reveal">
                    <div className="section-header">
                        ...
                        <p className="section-desc">
                            We&apos;re finalizing the production scope and pricing during our upcoming meeting. Package details and payment options will appear here once confirmed.
                        </p>
                    </div>

                    <div style={{ maxWidth: 640, margin: '0 auto', padding: '40px 32px', border: '1px solid rgba(99, 102, 241, 0.15)', borderRadius: 20, background: 'rgba(99, 102, 241, 0.04)', textAlign: 'center' }}>
                        <div style={{ fontSize: 32, marginBottom: 16 }}>📋</div>
                        <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 18, fontWeight: 600, color: 'var(--cream)', marginBottom: 8 }}>Pricing Under Review</div>
                        <div style={{ fontSize: 13, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 460, margin: '0 auto' }}>
                            All tiers include professional dual-camera coverage with matched Sony FX3 cinema bodies, professional audio, and organized footage delivery. Final pricing and package breakdowns will be shared after our next planning session.
                        </div>
                        <div style={{ marginTop: 20, padding: '10px 16px', borderRadius: 10, background: 'rgba(45, 212, 191, 0.06)', border: '1px solid rgba(45, 212, 191, 0.15)', display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 12, color: 'var(--teal)' }}>
                            🗓 Meeting scheduled — shoot is one month out
                        </div>
                    </div>
                </section>
                ...
                {/*
                ──────────────────────────────────────────
                ORIGINAL PRICING SECTION — TEMPORARILY HIDDEN
                Uncomment below when pricing is finalized
                ──────────────────────────────────────────
                */}
                ...
                {/*
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 24 }}>
                        <div style={{ padding: '32px 24px', border: '1px solid rgba(99, 102, 241, 0.35)', borderRadius: 16, background: 'linear-gradient(135deg, var(--panel), rgba(99, 102, 241, 0.06))', position: 'relative', transition: 'all 0.3s' }}>
                            ...
                            ... PRICING CONTENT HIDDEN — RESTORE AFTER MEETING ...
                        </div>
                    </div>
                </section>
                */}
