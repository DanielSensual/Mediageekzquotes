        ...
        <>
            ...
            <div className="page-shell">
                ...
                <section className="ed-section reveal">
                    ...
                    {/* ── Square Payment ── */}
                    <div style={{ maxWidth: 740, marginTop: 32 }}>
                        <div style={{ padding: '28px 24px', border: '1px solid rgba(220, 165, 80, 0.4)', borderRadius: 20, background: 'radial-gradient(circle at top right, rgba(220, 165, 80, 0.1), transparent 50%), var(--panel)', textAlign: 'center' }}>
                                ...
                                return (
                                    <a
                                        ...
                                        style={{
                                            ...
                                            textDecoration: 'none',
                                            boxShadow: '0 8px 28px rgba(220, 165, 80, 0.35)',
                        ...
                        <div style={{ textAlign: 'center', marginTop: 16 }}>
                            <a href="mailto:danielcastillo@mediageekz.com?subject=Elfman%20Doc-Series%20%E2%80%94%20Question&body=Hey%20Daniel%2C%0A%0A" style={{ color: 'var(--muted-2)', fontSize: 12, textDecoration: 'none' }}>
