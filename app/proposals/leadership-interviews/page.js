...
const ADDONS = [
    ...
    { id: 'teleprompter', label: 'Teleprompter Operator + Gear', detail: 'Full day — guided reads for talent', price: 350 },
                ...
                <div className="li-hero">
                    ...
                    <div className="hero-meta">
                        ...
                        <div className="hero-stat">
                            ...
                            <div className="hero-stat-detail">9:30 AM – 6:00 PM</div>
                        </div>
                        <div className="hero-stat">
                        ...
                        <div className="hero-stat">
                            ...
                            <div className="hero-stat-value">On-Site</div>
                            <div className="hero-stat-detail">Client meeting space</div>
                        </div>
                    </div>
                </div>
                ...
                <section className="li-section reveal">
                    ...
                    <div className="timeline">
                        <div className="timeline-block">
                            <div className="timeline-time">9:30 – 10:15 AM</div>
                            <div className="timeline-label">Arrive + Setup</div>
                            <div className="timeline-desc">Scout room lighting, position cameras for dual angles, set up lighting kit, test wireless lavs and audio levels. Dress the set.</div>
                        </div>
                        <div className="timeline-block">
                            <div className="timeline-time">10:15 – 10:30 AM</div>
                        ...
                        <div className="timeline-block">
                            ...
                            <div className="timeline-label">Interview 1 — Recording</div>
                            <div className="timeline-desc">First two-person leadership interview. Multi-cam coverage with A-cam on hero angle and B-cam on reaction/wide. 15–20 min runtime.</div>
                        </div>
                        <div className="timeline-block">
                            <div className="timeline-time">12:00 – 1:00 PM</div>
                        ...
                        <div className="timeline-block">
                            <div className="timeline-time">1:00 – 2:30 PM</div>
                        ...
                        <div className="timeline-block">
                            <div className="timeline-time">3:00 – 4:30 PM</div>
                            <div className="timeline-label">Interview 3 — Recording</div>
                            <div className="timeline-desc">Final leadership interview. Full multi-cam setup with any lessons learned from the morning sessions applied.</div>
                        </div>
                        <div className="timeline-block">
                            <div className="timeline-time">4:30 – 6:00 PM</div>
                            <div className="timeline-label">Wrap + Pickup Shots</div>
                            <div className="timeline-desc">Additional B-roll if needed. Pack gear, offload media to backup drive. Confirm all files are verified.</div>
                        </div>
                    </div>
                </section>
