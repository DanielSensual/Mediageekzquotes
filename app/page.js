            ...
            {/* ═══ CLIENT PROPOSALS ═══ */}
                <section className={`tenant-list ${mounted ? 'tenant-visible' : ''}`} style={{ marginTop: 24 }}>
                    ...
                    <div className="vertical-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
                        {[
                            { href: '/thread', icon: '🧵', name: 'ThreadLink', desc: 'Brand story + community video production', status: 'Active', total: 5775, paid: 0 },
                            ...
                            { href: '/proposals/andy-the-coach', icon: '🏗️', name: 'Andy The Coach', desc: 'Blue Collar Business — Live stream + content', status: 'Active', total: 0, paid: 0 },
