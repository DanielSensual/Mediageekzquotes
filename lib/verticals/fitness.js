...
module.exports = {
    ...
    services: [
        ...
        { slug: 'challenge-video', name: '30-Day Challenge Promo Video', category: 'deliverable', standard: 500, senior: 800, mode: 'boolean', sort: 8 },
        { slug: 'nutrition-tips-edit', name: 'Nutrition / Wellness Tips Edit (per ep)', category: 'deliverable', standard: 250, senior: 400, mode: 'quantity', sort: 9 },
        { slug: 'athlete-highlight-reel', name: 'Athlete Highlight Reel (competition cuts)', category: 'deliverable', standard: 700, senior: 1100, mode: 'boolean', sort: 10 },
        { slug: 'class-demo', name: 'Class Demo Promo (Yoga/Spin/HIIT, 60s)', category: 'deliverable', standard: 200, senior: 350, mode: 'quantity', sort: 11 },
        { slug: 'member-testimonial', name: 'Member Testimonial Edit (before/after story)', category: 'deliverable', standard: 300, senior: 500, mode: 'quantity', sort: 12 },
    ],
