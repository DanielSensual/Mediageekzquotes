...
module.exports = {
    ...
    services: [
        ...
        { slug: 'recap-daily', name: 'Daily Recap Reel (end-of-day social post)', category: 'deliverable', standard: 400, senior: 650, mode: 'quantity', sort: 8 },
        { slug: 'speaker-spotlight', name: 'Speaker Spotlight Package (per speaker)', category: 'deliverable', standard: 350, senior: 550, mode: 'quantity', sort: 9 },
        { slug: 'social-clip-pack', name: 'Social Clip Pack (10 vertical clips from sessions)', category: 'deliverable', standard: 600, senior: 1000, mode: 'boolean', sort: 10 },
        { slug: 'sponsor-bumper', name: 'Animated Sponsor Bumper (15s)', category: 'deliverable', standard: 200, senior: 350, mode: 'quantity', sort: 11 },
        { slug: 'after-movie', name: 'After-Movie Cinematic Wrap (5-8 min)', category: 'deliverable', standard: 2000, senior: 3200, mode: 'boolean', sort: 12 },
    ],
