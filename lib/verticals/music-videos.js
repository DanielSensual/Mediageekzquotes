...
module.exports = {
    ...
    services: [
        ...
        { slug: 'performance-one-take', name: 'One-Take Performance Edit (no cuts, graded)', category: 'deliverable', standard: 800, senior: 1300, mode: 'boolean', sort: 8 },
        { slug: 'vertical-music-vid', name: 'Vertical Music Video (9:16, TikTok/IG)', category: 'deliverable', standard: 1200, senior: 2000, mode: 'boolean', sort: 9 },
        { slug: 'concert-live-cut', name: 'Live Concert Multi-Cam Cut', category: 'deliverable', standard: 1500, senior: 2500, mode: 'boolean', sort: 10 },
        { slug: 'album-visualizer-pack', name: 'Album Visualizer Pack (per track)', category: 'deliverable', standard: 200, senior: 350, mode: 'quantity', sort: 11 },
        { slug: 'press-kit-edit', name: 'EPK / Press Kit Edit (2-3 min)', category: 'deliverable', standard: 600, senior: 1000, mode: 'boolean', sort: 12 },
    ],
