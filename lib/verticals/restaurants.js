...
module.exports = {
    ...
    services: [
        ...
        { slug: 'seasonal-menu-promo', name: 'Seasonal Menu Promo (30-60s)', category: 'deliverable', standard: 400, senior: 650, mode: 'boolean', sort: 8 },
        { slug: 'happy-hour-bumper', name: 'Happy Hour Bumper (15s loop)', category: 'deliverable', standard: 200, senior: 350, mode: 'boolean', sort: 9 },
        { slug: 'influencer-collab-edit', name: 'Influencer Collab Edit (reaction + B-roll)', category: 'deliverable', standard: 350, senior: 550, mode: 'boolean', sort: 10 },
        { slug: 'google-review-card', name: 'Google Review / Yelp Testimonial Card (animated)', category: 'deliverable', standard: 100, senior: 175, mode: 'quantity', sort: 11 },
        { slug: 'catering-sizzle', name: 'Catering Sizzle Reel (2-3 min)', category: 'deliverable', standard: 800, senior: 1300, mode: 'boolean', sort: 12 },
    ],
