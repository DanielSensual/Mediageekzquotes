...
module.exports = {
    ...
    services: [
        ...
        { slug: 'culture-reel', name: 'Company Culture Reel (recruiting, 2-3 min)', category: 'deliverable', standard: 1500, senior: 2500, mode: 'boolean', sort: 8 },
        { slug: 'event-summary', name: 'Event / Conference Summary Edit (3-5 min)', category: 'deliverable', standard: 1200, senior: 2000, mode: 'boolean', sort: 9 },
        { slug: 'social-proof-montage', name: 'Client Social Proof Montage (testimonials)', category: 'deliverable', standard: 800, senior: 1300, mode: 'boolean', sort: 10 },
        { slug: 'sop-screen-capture', name: 'SOP / Process Screen Capture Edit', category: 'deliverable', standard: 400, senior: 650, mode: 'quantity', sort: 11 },
        { slug: 'ceo-message', name: 'CEO / Founder Message (branded, chaptered)', category: 'deliverable', standard: 600, senior: 1000, mode: 'boolean', sort: 12 },
    ],
